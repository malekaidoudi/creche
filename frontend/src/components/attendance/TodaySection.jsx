...
const TodaySection = ({
  ...
  return (
    <div className="space-y-6">
      {/* Statistiques du jour - Version Desktop */}
      ...
      {/* Statistiques du jour - Version Mobile Collapsible */}
      <motion.div
              ...
              return filteredChildren.map((child) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center space-x-3 rtl:space-x-reverse">
                        <div className={`w-10 h-10 rounded-full flex items-center justify-center ${isPresent ? 'bg-green-100 dark:bg-green-900' :
                            isCompleted ? 'bg-blue-100 dark:bg-blue-900' :
                              'bg-gray-100 dark:bg-gray-700'
                          }`}>
                          <Baby className={`w-5 h-5 ${isPresent ? 'text-green-600 dark:text-green-400' :
                      ...
                      <div className={`px-2 py-1 rounded-full text-xs font-medium ${isPresent ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300' :
